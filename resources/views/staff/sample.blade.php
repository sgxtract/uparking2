                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                @for ($i = 13; $i <= 14; $i++)
                                    ...
                                    @if ($obj->status =='reserved')
                                        <label class="fancy-checkbox-label" id="slot-{{ $i }}" data-toggle="modal" data-target="#myModal2">
                                            <input type="radio" onclick="func()" value="Slot {{ $i }}" name="slots">
                                            <span class="fancy-checkbox fancy-checkbox-img"></span>
                                    ...
                                    @else
                                        <label class="fancy-checkbox-label" id="slot-{{ $i }}" data-toggle="modal" data-target="#myModal">
                                            <input type="radio" onclick="func()" value="Slot {{ $i }}" name="slots">
                                            <span class="fancy-checkbox fancy-checkbox-img"></span>
                                ...
                                @for ($i = 15; $i <= 34; $i++)
                                    ...
                                    @if ($obj->status =='reserved')
                                        <label class="fancy-checkbox-label" id="slot-{{ $i }}" data-toggle="modal" data-target="#myModal2">
                                            <input type="radio" onclick="func()" value="Slot {{ $i }}" name="slots">
                                            <span class="fancy-checkbox fancy-checkbox-img"></span>
                                            <img src="{{ asset('images/cars/car-orange-btm.png') }}" width="27" height="55">
                                        </label>
                                                            ...
                                                            <div class="input-group col-xs-12">
                                                                ...
                                                                <span class="input-group-append">
                                                                    <button type="submit" class="btn btn-dark btn-fw">
                                                                        <i class="mdi mdi-map-marker-radius"></i>Check
                                                                        In</button>
                                                                </span>
                                                            </div>
                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h5> <span class="mdi mdi-alert"></span></h5>
                                                    <hr>
                                                    <div class="row mt-3">
                                                        <div class="col-md-4">
                                                            <p>Plate Number:</p>
